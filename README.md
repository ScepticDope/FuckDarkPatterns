...
_Strips the dark pattern UX from the new YouTube embedded player, re-adds the play/pause, fullscreen and mute buttons, fullscreen via double-click, volume slider, volume control by arrow keys, 5 seconds arrow key scrubbing, position jumping via the 0–9 keys and Shift + < or > to control playback speed._
...
3. Copy paste entire code from a userscript here. No wait, hold on, not literrally here, replace all the code in your new script file instead.
4. Save.
...
Changing these lines will prevent the script from properly executing. Do not contact me with this dumb question, there may be consequences.
